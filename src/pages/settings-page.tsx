        ...
        <div className="flex flex-1 gap-6 p-5 min-h-0 overflow-y-auto">
          ...
          <div className="w-56 shrink-0">
            ...
            <div className="border border-(--border-custom) rounded-xl p-4">
              ...
              <button className="w-full h-7 rounded-lg bg-linear-to-br from-teal-500 to-cyan-500 text-white text-[0.7rem] font-semibold hover:-translate-y-px hover:shadow-[0_4px_16px_rgba(20,184,166,0.3)] transition-all">
                Seu Perfil
              </button>
            </div>
          </div>
